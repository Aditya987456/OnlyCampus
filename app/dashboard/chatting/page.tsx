...
export default function ChatPage() {
    ...
    return (
        <div className="flex min-h-[min(70dvh,28rem)] flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-2xl md:h-[min(75dvh,calc(100dvh-10rem))] md:max-h-[min(80dvh,calc(100dvh-8rem))] md:flex-row">
            
            {/* Left Panel: Contacts List */}
            <div className="flex max-h-[min(42dvh,18rem)] w-full flex-shrink-0 flex-col overflow-hidden border-b border-gray-100 md:max-h-none md:h-auto md:w-72 md:flex-shrink-0 md:overflow-visible md:border-b-0 md:border-r lg:w-80">
                <div className={`p-4 border-b border-gray-100 bg-gray-50`}>
                    <h2 className={`text-xl font-bold text-${NEUTRAL_COLOR} flex items-center gap-2`}>
                        <Users className='w-6 h-6 text-green-500'/> Contacts
                    </h2>
            ...
            {/* Right Panel: Chat Window */}
            <div className="flex min-h-[min(50dvh,20rem)] flex-1 flex-col md:min-h-0">
                {selectedContact ? (
                    <>
                        {/* Chat Header */}
                        <div className={`p-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50`}>
