...
//   // save token -----------> saving in localstorage in browser in client side....
      ...
      <div className="relative flex w-full max-w-7xl flex-col items-stretch justify-center gap-8 px-4 sm:flex-row sm:items-center sm:justify-between sm:gap-10 sm:px-6 lg:px-12 xl:gap-24 xl:px-20">
        ...
        >
          ...
          <input
            ...
            value={email}
            onChange={(e) => setEmail(e.target.value)}
            className="w-full mt-1 p-3 border rounded-lg text-gray-700 focus:ring-2 focus:ring-green-600 focus:border-green-600 outline-none"
            required
          />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 text-white font-semibold rounded-lg bg-green-600 hover:bg-green-700 shadow-md transition mt-6 disabled:opacity-70"
          >
            {loading ? "Signing in..." : "Sign In"}
          </button>
